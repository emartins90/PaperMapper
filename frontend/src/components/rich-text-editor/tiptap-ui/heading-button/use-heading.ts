...
import {
  ...
  isNodeTypeSelected,
  isValidPosition,
} from "@/components/rich-text-editor/tiptap-utils"

// --- Icons ---
import { HeadingOneIcon } from "@/components/rich-text-editor/tiptap-icons/heading-one-icon"
import { HeadingTwoIcon } from "@/components/rich-text-editor/tiptap-icons/heading-two-icon"
import { HeadingThreeIcon } from "@/components/rich-text-editor/tiptap-icons/heading-three-icon"
