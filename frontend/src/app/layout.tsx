    ...
    <script
      dangerouslySetInnerHTML={{
        __html: `
          ...
          console.log('[DEBUG] Checking consent before PostHog init...');
          ...
          posthog.init('${posthogKey}', {
            ...
            loaded: function(posthog) {
              ...
              console.log('[DEBUG] PostHog config after init:', {
                cookieless_mode: posthog.config.cookieless_mode,
                advanced_enable_surveys: posthog.config.advanced_enable_surveys,
                persistence: posthog.config.persistence
              });
            }
          });
          
          console.log('[DEBUG] PostHog init called');
